...
bool Renderer::Render()
{
	...
	}
	{
		...
		sceneBuffer.push_back({ DirectX::XMMatrixTranslation(4.75f, 0.7f, 0.9f), {1.0f, 0.3f, 0.2f, 0.5f} });
		sceneBuffer.push_back({ DirectX::XMMatrixTranslation(-5.5f, 1.0f, 0.5f), { 0.7f, 1.0f, 0.2f, 0.5f } });
		sceneBuffer.push_back({ DirectX::XMMatrixTranslation(-3.1f, 2.0f, 0.5f), { 0.8f, 0.2f, 1.0f, 0.5f } });
